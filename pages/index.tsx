...
import {  getAnimeNews, getSeasonNowAnime, getSeasonUpcomingAnime, getSeasonYearAnime } from './api/anime'
...
export const getStaticProps = async() => {
  const [seasonsNow,seasonYear,seasonsUpcoming] = ([await getSeasonNowAnime(),await getSeasonYearAnime(2022,'spring'),await getSeasonUpcomingAnime()]);
