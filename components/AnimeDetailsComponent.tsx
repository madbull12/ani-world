            ...
            <div>
                <div className='relative'>
                    ...
                    <div className='absolute z-50 md:-bottom-36 lg:-bottom-40 left-0  pt-4 md:pt-0 px-8 flex flex-col items-start md:flex-row  gap-x-8 w-full gap-y-2'>
                            ...
                            <Image alt={anime.title} src={anime.images.jpg.large_image_url} width={220} height={300} className="rounded-lg relative z-[999]" objectFit='cover' />
                ...
                <section className='bg-[#007CEF] w-full py-4 pr-4 text-white'>
                    ...
                    <div className='p-8 flex gap-x-4 mt-80 md:mt-8'>
                        <div className='text-white bg-[#FF9901] rounded-full md:rounded-lg w-[50px] h-[50px] md:h-auto md:w-auto grid place-items-center p-2 self-start md:flex md:flex-col md:items-center'>
                            ...
                            <span className='text-base md:text-2xl font-bold'>{anime.score || "N/A"}</span>
                        ...
                        <div className='rounded-lg border-2 border-gray-700 p-3 space-y-2 flex flex-col '>
                            ...
                            <div className="space-x-4">
                             <span className='font-semibold'>Duration: <span className='font-normal'>{anime.duration}</span></span>
                             <span className='font-semibold'>Rating: <span className='font-normal'>{anime.rating}</span></span>
                             <span className='font-semibold'>Source: <span className='font-normal'>{anime.source}</span></span>
